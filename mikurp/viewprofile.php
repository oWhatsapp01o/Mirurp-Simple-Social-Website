...
$ownaccountID = $_SESSION['account'];
  $ownaccount=mysqli_query($con,"SELECT account.* from account where accountID = '$ownaccountID'")or die(mysqli_error($con));
      $rowownaccount=mysqli_fetch_object($ownaccount);
...
<nav class="w3-sidebar w3-collapse  w3-animate-left" style="z-index:3;width:300px;  background-image: linear-gradient(-225deg, #E3FDF5 50%, #FFE6FA 50%);" id="mySidebar"><br>
  <div class="w3-container w3-row">
    <div class="w3-col s4">
      <img src="<?php echo "pic/".$rowownaccount->image;?>" class="w3-circle w3-margin-right" style="width:46px ; height: 50px; width: 50px">
    </div>
    <div class="w3-col s8 w3-bar">
      <span>Welcome, <strong><?php echo $rowownaccount->name; ?></strong></span><br>
  ...
  <div class="w3-bar-block">
   ...
   <!--  <a href="#" class="w3-bar-item w3-button w3-padding w3-light-blue"><i class="fa fa-home fa-fw"></i>  Home</a> -->
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <pre><b><i class="fa fa-profile"></i>Profile Of: </b><i><span><?php echo $row->name; ?></span></i></pre>
  </header>
...
?>
      ...
      <div class="profile-bio">
        ...
        <p><span class="profile-real-name"><hr></span>gg</p>
